...
Looking for number of unique values and number of NA's per column.

Can also check for columns close to 0.
...
Save tidied data for shiny app use:
...
Need to transform the data to google maps style 4326 to work in leaflet.
