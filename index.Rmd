...
The data is skewed to the point where the fill color doesn't provide much meaningful differentiation. This can be solved by Next Checking the relationship between variables to best determine how to normalize.
...
[hist() details](https://www.r-graph-gallery.com/2-two-histograms-with-melt-colors.html)
...
ggplot() + 
    ...
    scale_fill_gradient2(name = 'Migration per 10k') 
```
